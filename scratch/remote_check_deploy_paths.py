...
def main():
    try:
        ...
        print("--- Listado de public_html ---")
        cmd = "ls -la /home/u114856156/domains/mysmartdomains.com/public_html/"
        stdin, stdout, stderr = ssh.exec_command(cmd)
        print(stdout.read().decode('utf-8'))
        
        print("\n--- Listado de public_html/panel ---")
        cmd_panel = "ls -la /home/u114856156/domains/mysmartdomains.com/public_html/panel/"
        stdin, stdout, stderr = ssh.exec_command(cmd_panel)
        print(stdout.read().decode('utf-8'))
